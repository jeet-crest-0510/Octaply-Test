...
# from Utils.verification_code import get_verification_code
            ...
            try:
                ...
                if pattern['description'] == "Employment status":
                    ...
                    if (available.data.model_response == 'Y'):
                        ...
                        print(f"✅ Handled {pattern['description']} popup")
                    ...
                    if (available.data.model_response == 'Y'):
                        ...
                        # Select Surat from the dropdown (step 2: click matching option)
                        await client.windows.click(
                            session_id=session_id,
                            window_id=window_id,
                            element_description='[role="option"]:has-text("Surat")'
                        )
